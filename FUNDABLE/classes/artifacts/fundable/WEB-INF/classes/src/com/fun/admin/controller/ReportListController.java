...
public class ReportListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        listCount = new BoardService().selectReListCount();
        ...
        ArrayList<Report> list = new BoardService().selectReList(pi);

        request.setAttribute("list", list);

        request.getRequestDispatcher("/views/member/admin/reportListView.jsp").forward(request, response);
