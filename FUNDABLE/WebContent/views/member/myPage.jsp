  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <a href="" style="margin: 0;"> <img src="<%= contextPath %>/<%= pList.get(i).getFilePath() + pList.get(i).getChangeName() %>" id="modal-img"></a>
          <div style="margin-top: 2vh; padding-left: 1vw; width:100%" >
            <p id="mypage-product-brand" style="margin-bottom: 0.6vh;"><!--브랜드명--> <a href="" style="font-size: 15px;" id="modal-brand"><%= pTextList.get(i).getSellerNickName() %> </a></p>
          <span id="mypage-product-title"><!--상품명--> <a href="<%=contextPath %>/fsi.bo?productNo=<%= pTextList.get(i).getProductNo()%>" style="font-size: 16px;" id="modal-title"><%= pTextList.get(i).getProductTitle() %></a></span>
          <p id="mypage-product-option" style="font-size: 11px; margin-top: 1vh; margin-bottom: 1.5vh;"><!--옵션-->옵션 : <%= pTextList.get(i).getOptionName() %> &nbsp; <br> 결제금액 : <%= df.format(pTextList.get(i).getTotalPrice()) %>원</p>
